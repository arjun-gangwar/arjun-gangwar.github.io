...
// Giscus (comments) — fill these in after setting up at https://giscus.app
// Steps: enable Discussions on the repo, create a "Blog Comments" category
...
// your code here (dashboard will be at https://<code>.goatcounter.com).
export const GOATCOUNTER_CODE = 'arjungangwar';
